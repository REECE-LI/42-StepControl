...
//APP_CALI
#define        STOCKPILE_APP_CALI_ADDR                    (0x08037000)        //起始地址
#define        STOCKPILE_APP_CALI_SIZE                    (0x00008000)        //Flash容量    32K    XDrive(APP_CALI)(可容纳16K-2byte校准数据-即最大支持14位编码器的校准数据)
//APP_DATA
#define        STOCKPILE_APP_DATA_ADDR                    (0x0803F000)        //起始地址
#define        STOCKPILE_APP_DATA_SIZE                    (0x00000800)        //Flash容量     2K    XDrive(APP_DATA)
